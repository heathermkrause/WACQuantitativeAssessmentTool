...
#step 3b: The webtool needs to ingest this list of up to ten names as a vector saved as "keyvarXnames" where the X is replaced by a number between 1 and 10 - once for each key identity variables
...
#Step 3b: Webtool needs to ingest this vector as "keyvarXcodes" where the X is replaced by a number between 1 and 10 - once for each key identity variables
